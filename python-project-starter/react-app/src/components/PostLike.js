...
const PostLike = ({postId, post, user}) => {
    ...
    const likeCount = () => {
      ...
      useEffect(() => {
        if (post) {
          if (post.likesUsers.includes(sessionUser.id)) {
            setIsLiked(true);
